    ...
    if 2 < len(message.text) < 50:    
        ...
        if len(btn) > 10: 
            ...
            await message.reply_text(
                f"<b>ᴊᴏɪɴ @CP_S4U_Links ꜰᴏʀ ᴀʟʟ ᴏᴜʀ ᴄʜᴀɴɴᴇʟ ʟɪɴᴋꜱ 👇 ʜᴇʀᴇ ɪꜱ ᴛʜᴇ ʀᴇꜱᴜʟᴛꜱ ꜰᴏʀ yᴏᴜʀ qᴜᴇʀy👇</b>",
    ...
    if (clicked == typed) or (clicked in AUTH_USERS):
        ...
        if query.data.startswith("next"):
            ...
            keyboard = InlineKeyboardMarkup([
                ...
                [InlineKeyboardButton("⭕️ JOIN OUR CHANNEL ⭕️", url="https://t.me/CP_S4U_Links")]
            ])
            ...
            keyboard = InlineKeyboardMarkup([
                [InlineKeyboardButton("BACK", callback_data="start_data"),
                    InlineKeyboardButton("ABOUT", callback_data="about_data")],
                [InlineKeyboardButton("⭕️ MOVIE GROUP ⭕️", url="https://t.me/cinemapedika")]
            ])
        ...
        await query.answer("എന്റെ മോനേ അത് നിനക്ക് ഉള്ളതല്ല . ",show_alert=True)
